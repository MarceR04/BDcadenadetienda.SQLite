...
INSERT INTO
    Producto (id, nombre, marca, categoria_id, precio_unitario)
VALUES
...
INSERT INTO
    Stock (id, sucursal_id, producto_id, cantidad)
VALUES
    (1, 1, 1, 65),
    (2, 1, 2, 71),
    (3, 1, 3, 8),
...
INSERT INTO
    Orden (id, cliente_id, sucursal_id, fecha, total)
VALUES
...
INSERT INTO
    Item (id, orden_id, producto_id, cantidad, monto_venta)
VALUES
    (1, 1, 9, 7, 175),
    (2, 1, 8, 8, 400),
    (6, 2, 9, 3, 75),
